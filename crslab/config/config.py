...
class Config:
    ...
    def __init__(self, config_file, current_method=None, gpu='-1', debug=False):
        ...
        if not current_method:
            ...
            log_name = current_method + self.opt.get("log_name", dataset + '_' + model_name + '_' + time.strftime("%Y-%m-%d-%H-%M-%S",
                                                                                                 time.localtime())) + ".log"
